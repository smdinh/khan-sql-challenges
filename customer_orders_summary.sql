...
-- Step 1: List the name and email of every customer followed by the item and price of orders they've made
...
-- Step 2: List one row per each customer, with their name, email, and total amount of money they've spent on orders, sorted according to the total money spent, from the most spent to the least spent
SELECT customers.name,
       customers.email,
