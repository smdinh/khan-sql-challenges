...
-- Step 2: Select the titles of the songs that have an 'epic' mood or a release date after 1990
SELECT title
FROM songs
WHERE mood = "epic"
      OR released > 1990;

-- Step 3: Select the titles of songs that are 'epic', and released after 1990, and less than 4 minutes long
SELECT title
FROM songs
WHERE mood = "epic"
      AND released > 1990
